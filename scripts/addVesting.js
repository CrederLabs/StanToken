...
async function main() {
    ...
    const userAddresses = [
      ...
      // "0x263F67a04282cE2B8Cdaab260Ad36079f333d100",
      // "0xaDef029F4f8BE4F2d03F1f758E95D76F8DF48e1D"
      // "0x27E1169a9fbF7C5594d6Ab86302f621f21b3Fef5"
      // "0x24eCEB69d36D4BB72a889863905e5ebF1d85b53e"
    ...
    for (let i = 0; i < userAddresses.length; i++) {
      for (let j = 0; j < 10; j++) {
        ...
        let tx = await stanToken.lock(userAddresses[i], vestingAmount, currentTimestamp + 600 + 600 * j);
        await tx.wait();
        console.log(userAddresses[i] + ": " + vestingAmount + " STAN is locked until " + new Date((currentTimestamp + 600 + 600 * j) * 1000).toUTCString());
      }
    }
